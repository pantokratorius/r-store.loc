    ...
    <div class="co-delivery_adress-form">
      ...
      <div class="variants payment_variants co-payment_method-list co-checkout-block"  id="payment_gateways" style="position: relative; z-index: inherit;">
        ...
        <div class="checkout-button-wrap">
          <p>Оформляя заказ я согласен на обработку <a href="{{route('personal')}}" target="_blank">персональных данных</a> и прочитал <a href="{{route('agreement')}}"  target="_blank">пользовательское соглашение</a></p>
