              ...
              <div class="contacts-top-menu-block cell-12 hidden">
                <div class="header-block js-contacts-header cell- ">
                  ...
                  <div class="phone text-left ">
                    ...
                    <a href="tel:+7(988)13-222-02" class="contact-link tel">
                      +7(988)13-222-02
                    </a>
                  ...
                  @foreach($res as $k=>$v)
                        ...
                        <li class="sidebar-menu-item menu-item level-1 has-submenu">
                          <div class="sidebar-menu-item-controls menu-item-controls level-1">
                            ...
                            <a href="{{route('category', $i) }}" class="sidebar-menu-link menu-link level-1" data-menu-link="airpods"
...
@endphp                       
  ...
  <style type="text/css">
    ...
    .image-container.is-rectangle img,
    .image-container.is-square img,
    .image-container.is-rectangle-widget-blogs img,
    .image-container.is-rounded img {
      position: absolute;
      top: 50%;
      left: 50%;
